...
const Articles = props => {
    const article = [
        { id: 0, name: "L'agriculture va-t-elle manquer d'eau ?", urlPic: require("../assets/img/article/article1.jpg"), urlPage: "/firstarticle" },
        ...
        { id: 3, name: "Origine et domestication du maïs", urlPic: require("../assets/img/article/article4.jpg"), urlPage: "/firstarticle" },
    ];
    return (
        <div>
